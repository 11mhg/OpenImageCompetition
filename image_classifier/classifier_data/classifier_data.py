...
class Data:
    def __init__(self, classes_text, image_size=(224,224,3),batch_size=32, shuffle_buffer_size=4, prefetch_buffer_size=1,num_parallel_calls=4 , num_parallel_readers=1):
...
class PreProcessData:
    def __init__(self,classes_text='./dummy_labels.txt',image_size=(224,224)):
        self.images = None
        self.labels = None
        self.image_size=image_size
